...
\-----------------------------------------------------------------------------*/
    ...
    public string $VLIBTEMPLATE_DEBUGMOD = './vlibTemplate/vlibTemplate_debugmod.html';
    public string $VLIBTEMPLATE_DEBUGWRAPPER = './vlibTemplate/vlibTemplate_debugmodwrapper.html';
	// 2006-08-12, SD: new option 'DEBUG_WITHOUT_JAVASCRIPT'
    public string $VLIBTEMPLATE_DEBUGMOD_NO_JAVASCRIPT = './vlibTemplate/vlibTemplate_debugmod_no_javascript.html';
    public string $VLIBTEMPLATE_DEBUGWRAPPER_NO_JAVASCRIPT = './vlibTemplate/vlibTemplate_debugmodwrapper_no_javascript.html';
    ...
    public $_debugIncludedfiles = array();
    public $_debugTemplatevars = array();

    public $_debugalltags = array();
    public $_debugtags = array();

    public $_debugwarnings = array();
    public $_debugwarningmsgscontrol = array();
    public $_debugwarningmsgs = array();
    ...
    */
    function doDebug() {
        ...
        $wrapper_tmpl->setvar('securecode', md5((string) time()));
		// 2006-08-12, SD: new option 'DEBUG_WITHOUT_JAVASCRIPT'
		if($this->OPTIONS['DEBUG_WITHOUT_JAVASCRIPT'])
		{
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    {return true;}
    function recache(): bool
    {return true;}
    function setCacheLifeTime(): bool
    {return true;}
    function setCacheExtension(): bool
    {return true;}
}